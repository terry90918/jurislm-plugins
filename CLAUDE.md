...
| lessons-learned | 1.7.0 | Skill Only | 66 經驗模式：診斷除錯、測試、基礎設施、安全、架構、業務邏輯、雲端遷移、前端工具鏈、Docker 部署、資料匯入與 Migration |
...
> 更多詳細的開發經驗模式（66 個模式，12 個分類）已整合至 **lessons-learned plugin**。
